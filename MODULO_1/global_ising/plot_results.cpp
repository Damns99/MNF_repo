...
int main(int argc, char* argv[]) {
    std::string folder = "measures", tmp_folder, infilename, outname, xname;
	...
	plotGraph(nmeas, x.data(), E.data(), nullptr, dE.data(), xname, "#varepsilon", tmp_folder, outname + "E");
	plotGraph(nmeas, x.data(), M.data(), nullptr, dM.data(), xname, "M", tmp_folder, outname + "M");
	plotGraph(nmeas, x.data(), C.data(), nullptr, dC.data(), xname, "d#varepsilon/dT", tmp_folder, outname + "C");
	plotGraph(nmeas, x.data(), K.data(), nullptr, dK.data(), xname, "dM/dh", tmp_folder, outname + "K");
	plotGraph(nmeas, x.data(), BE.data(), nullptr, dBE.data(), xname, "B(#varepsilon)", tmp_folder, outname + "BE");
	plotGraph(nmeas, x.data(), BM.data(), nullptr, dBM.data(), xname, "B(M)", tmp_folder, outname + "BM");
}