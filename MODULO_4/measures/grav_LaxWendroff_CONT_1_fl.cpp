...
#endif
void grav_LaxWendroff_CONT_1_fl()
{
//=========Macro generated from canvas: canvas2/Canvas2
//=========  (Fri Jun 17 17:25:50 2022) by ROOT version 6.26/00
   ...
   multigraph->SetName("");
   multigraph->SetTitle("grav_LaxWendroff_CONT_1;x;u(x,t)");
   
   Double_t Graph_fx23[500] = {
   -0.6,
   -0.598,
   -0.596,
   -0.594,
   ...
   -3.792193e-12,
   -2.774255e-12};
   TGraph *graph = new TGraph(500,Graph_fx23,Graph_fy23);
   graph->SetName("Graph");
   graph->SetTitle("Graph");
   graph->SetFillStyle(1000);
   
   TH1F *Graph_Graph23 = new TH1F("Graph_Graph23","Graph",500,-0.6998,0.4978);
   Graph_Graph23->SetMinimum(-14.55674);
   Graph_Graph23->SetMaximum(14.55674);
   ...
   TH1F *Graph_Graph24 = new TH1F("Graph_Graph24","Graph",500,-0.6998,0.4978);
   Graph_Graph24->SetMinimum(-14.67785);
   Graph_Graph24->SetMaximum(14.44804);
   ...
   TPaveText *pt = new TPaveText(0.2811074,0.9304839,0.7188926,0.995,"blNDC");
   pt->SetName("title");
   pt->SetBorderSize(0);
   pt->SetFillColor(0);
   pt->SetFillStyle(0);
   pt->SetTextFont(42);
   TText *pt_LaTex = pt->AddText("grav_LaxWendroff_CONT_1");
   pt->Draw();
   canvas2->Modified();
   canvas2->cd();
