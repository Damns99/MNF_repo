...
#endif
void grav_LaxWendroff_COLZ_0_fl()
{
//=========Macro generated from canvas: canvas2/Canvas2
//=========  (Fri Jun 17 17:25:51 2022) by ROOT version 6.26/00
   ...
   multigraph->SetName("");
   multigraph->SetTitle("grav_LaxWendroff_COLZ_0;x;u(x,t)");
   
   Double_t Graph_fx25[500] = {
   -0.6,
   -0.598,
   -0.596,
   -0.594,
   ...
   2.394062e-14,
   1.742623e-14};
   TGraph *graph = new TGraph(500,Graph_fx25,Graph_fy25);
   graph->SetName("Graph");
   graph->SetTitle("Graph");
   graph->SetFillStyle(1000);
   
   TH1F *Graph_Graph25 = new TH1F("Graph_Graph25","Graph",500,-0.6998,0.4978);
   Graph_Graph25->SetMinimum(4.842168e-32);
   ...
   -0.01878045,
   -0.0187788};
   graph = new TGraph(500,Graph_fx26,Graph_fy26);
   graph->SetName("Graph");
   graph->SetTitle("Graph");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph26 = new TH1F("Graph_Graph26","Graph",500,-0.6998,0.4978);
   Graph_Graph26->SetMinimum(-0.1187537);
   Graph_Graph26->SetMaximum(1.079824);
   ...
   pt->SetFillStyle(0);
   pt->SetTextFont(42);
   TText *pt_LaTex = pt->AddText("grav_LaxWendroff_COLZ_0");
   pt->Draw();
   canvas2->Modified();
   canvas2->cd();
