...
#endif
void grav_LaxWendroff_COLZ_1_fl()
{
//=========Macro generated from canvas: canvas2/Canvas2
//=========  (Fri Jun 17 17:25:53 2022) by ROOT version 6.26/00
   ...
   multigraph->SetName("");
   multigraph->SetTitle("grav_LaxWendroff_COLZ_1;x;u(x,t)");
   
   Double_t Graph_fx27[500] = {
   -0.6,
   -0.598,
   -0.596,
   -0.594,
   ...
   -3.792193e-12,
   -2.774255e-12};
   TGraph *graph = new TGraph(500,Graph_fx27,Graph_fy27);
   graph->SetName("Graph");
   graph->SetTitle("Graph");
   graph->SetFillStyle(1000);
   
   TH1F *Graph_Graph27 = new TH1F("Graph_Graph27","Graph",500,-0.6998,0.4978);
   Graph_Graph27->SetMinimum(-14.55674);
   Graph_Graph27->SetMaximum(14.55674);
   ...
   -0.0176145,
   -0.0175653};
   graph = new TGraph(500,Graph_fx28,Graph_fy28);
   graph->SetName("Graph");
   graph->SetTitle("Graph");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph28 = new TH1F("Graph_Graph28","Graph",500,-0.6998,0.4978);
   Graph_Graph28->SetMinimum(-14.67785);
   Graph_Graph28->SetMaximum(14.44804);
   ...
   pt->SetFillStyle(0);
   pt->SetTextFont(42);
   TText *pt_LaTex = pt->AddText("grav_LaxWendroff_COLZ_1");
   pt->Draw();
   canvas2->Modified();
   canvas2->cd();
