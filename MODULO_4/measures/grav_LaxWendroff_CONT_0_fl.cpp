...
#endif
void grav_LaxWendroff_CONT_0_fl()
{
//=========Macro generated from canvas: canvas2/Canvas2
//=========  (Fri Jun 17 17:25:49 2022) by ROOT version 6.26/00
   ...
   multigraph->SetName("");
   multigraph->SetTitle("grav_LaxWendroff_CONT_0;x;u(x,t)");
   
   Double_t Graph_fx21[500] = {
   -0.6,
   -0.598,
   -0.596,
   -0.594,
   ...
   2.394062e-14,
   1.742623e-14};
   TGraph *graph = new TGraph(500,Graph_fx21,Graph_fy21);
   graph->SetName("Graph");
   graph->SetTitle("Graph");
   graph->SetFillStyle(1000);
   
   TH1F *Graph_Graph21 = new TH1F("Graph_Graph21","Graph",500,-0.6998,0.4978);
   Graph_Graph21->SetMinimum(4.842168e-32);
   ...
   -0.01878045,
   -0.0187788};
   graph = new TGraph(500,Graph_fx22,Graph_fy22);
   graph->SetName("Graph");
   graph->SetTitle("Graph");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph22 = new TH1F("Graph_Graph22","Graph",500,-0.6998,0.4978);
   Graph_Graph22->SetMinimum(-0.1187537);
   Graph_Graph22->SetMaximum(1.079824);
   ...
   TPaveText *pt = new TPaveText(0.2785906,0.9304839,0.7214094,0.995,"blNDC");
   pt->SetName("title");
   pt->SetBorderSize(0);
   pt->SetFillColor(0);
   pt->SetFillStyle(0);
   pt->SetTextFont(42);
   TText *pt_LaTex = pt->AddText("grav_LaxWendroff_CONT_0");
   pt->Draw();
   canvas2->Modified();
   canvas2->cd();
