...
int main(int argc, char* argv[]) {
    ...
    parser.addPosParameter<std::string>("measfile", &measfilename, "free_particle_meas.txt", "[std::string] Input file for the measures.");
    ...
    int nmeas = textIo::textIn(measfilename, '\t', '#', &particle, &obs1, &obs2);
